...
GUIA: dict[str, dict] = {
    ...
    "gerente": {
        ...
        "puedo": [
            ...
            {"titulo": "Leer el Informe", "descripcion": "Resumen ejecutivo del negocio.", "enlace": "/gerente/informe"},
            {"titulo": "Leer el Informe Estratégico", "descripcion": "Evolución mensual de fondo, no solo el día a día.", "enlace": "/gerente/estrategico"},
